...
assert numpy.round(gs_en,6)==numpy.round(-2.80277564,6) # RHS is calculated in test_HVQE.nb
...
inf=_HVQE.infidelity_from_parameters(init_reg,layers,n,par_multiplicity,parameters,gs_reg)
inf.backward()
...
-0.3164463289812076, -3.7855079246553895,-3.879886900967808, 
...
4.86518613798269,  0.917307768531554,-5.5444502641063185, 
6.266268104834758, 4.7765043994641445, 3.59062779362851, 
5.276025913422831, 4.927755050742828, 4.888912700553572, 
0.1315880185269016, 2.2552263123593193, -1.306859377781489, 
-0.9743835390864923, -2.905148883656384, -2.6995002982137706, 
-4.4101684202100255, -1.3593739583418731]))
...
# Kagome 2x2 opl
par_multiplicity=6
parameters=ch.Variable(xp.array([6.097430185765912,0.5166558411077276,-1.5384999770341423,-1.9514345193067513,-1.9078261812912594,-2.7691045498263342]))
